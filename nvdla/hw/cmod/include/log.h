...
#define cslDebug(args)                      cslDebugEmpty args
#define cslDebugEnable(args)                cslDebugInternal args


#define cslInfoEmpty(...)                do {\
                                            } while(0)
...
#define cslInfo(args)                       cslInfoEmpty args
#define cslInfoEnable(args)                 cslInfoInternal args
